...
- Lint: remove unused/unneccessary density-independend drawables (nextcloud/fixDensityIndependence) [https://github.com/nextcloud/android/pull/1515] conflicting
